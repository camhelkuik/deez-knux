...
;define("deez-knux/adapters/application", ["exports", "active-model-adapter", "@ember/object", "@ember/service"], function (_exports, _activeModelAdapter, _object, _service) {
  "use strict";
  ...
  0; //eaimeta@70e063a35619d71f0,"active-model-adapter",0,"@ember/object",0,"@ember/service"eaimeta@70e063a35619d71f
  ...
  let ApplicationAdapter = (_dec = (0, _object.computed)('session.data.authenticated.token'), (_class = class ApplicationAdapter extends _activeModelAdapter.default {
    constructor() {
      super(...arguments);
...
;define("deez-knux/authenticators/token", ["exports", "ember-simple-auth/authenticators/base"], function (_exports, _base) {
  "use strict";
...
;define("deez-knux/controllers/login", ["exports", "@ember/controller", "@ember/service", "@ember/object", "@glimmer/tracking"], function (_exports, _controller, _service, _object, _tracking) {
  "use strict";
...
;define("deez-knux/session-stores/application", ["exports", "ember-simple-auth/session-stores/cookie"], function (_exports, _cookie) {
  "use strict";
...
;
          if (!runningTests) {
            require("deez-knux/app")["default"].create({"name":"deez-knux","version":"0.0.0+cf91a991"});
          }
